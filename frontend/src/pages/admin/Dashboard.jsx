...
const Dashboard = () => {
  ...
  sx={{padding:"2rem", margin:'2rem', borderRadius:"1rem"}}>
    ...
    <AdminLayout>
      <Container component={"main"}>
        ...
        sx={{gap:"2rem"}}> 
          <Paper 
          elevation={3}
          sx={{padding:"2rem 3.5rem", borderRadius:"1rem", width:"100%", maxWidth:"45rem"}}>
            <Typography margin={"2rem 0"} variant={"h4"}>Last Messages</Typography>
            
           <LineChart value={[23,56,76,33]}/>
          </Paper>
          <Paper
          elevation={3}
          sx={{
         ...
         <DoughnutChart labels={["Single Chats","Group Chats"]} value={[60,40]}/>
          <Stack
          position={"absolute"}
          direction={"row"}
          justifyContent={"center"}
